...
<template>
  <section>
    ...
    <form @submit.prevent="form.patch(route('profile.update'))" class="mt-6 space-y-6">
      ...
      <div v-if="user.phone && user.phone_verified_at === null">
        <p class="mt-2 text-sm text-gray-800">
          ...
          >
            Click here to send the verification phone.
          </Link>
        </p>
      ...
      <div v-if="mustVerifyEmail && user.email != null && user.email_verified_at === null">
        <p class="mt-2 text-sm text-gray-800">
