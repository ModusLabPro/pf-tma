...
const theme = ref<CheckboxPassThroughOptions>({
  ...
  box: `flex justify-center items-center rounded-sm w-5 h-5
        ...
        p-checked:border-default p-checked:bg-default p-checked:text-white
        peer-enabled:peer-hover:p-checked:bg-default/50 peer-enabled:peer-hover:p-checked:border-default/50
