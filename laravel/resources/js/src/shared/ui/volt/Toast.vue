...
const theme = ref<ToastPassThroughOptions>({
    root: `max-md:max-w-[75%] md:w-96 rounded-md whitespace-pre-line break-words
    ...
    messageContent: `flex items-start p-2 md:p-3 gap-2`,
    messageIcon: `flex-shrink-0 text-lg w-[1.125rem] h-[1.125rem]`,
    messageText: `flex-auto flex flex-col`,
