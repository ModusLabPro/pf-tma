...
import type { RadioButtonPassThroughOptions, RadioButtonProps } from 'primevue/radiobutton';
...
const theme = ref<RadioButtonPassThroughOptions>({
  ...
  box: `flex justify-center items-center rounded-full
        border-2 border-default dark:border-surface-700
        bg-surface-0 dark:bg-surface-950
        peer-enabled:peer-hover:border-surface-400 dark:peer-enabled:peer-hover:border-surface-600
        p-checked:border-default p-checked:bg-default
        peer-enabled:peer-hover:p-checked:bg-default peer-enabled:peer-hover:p-checked:border-default
        peer-focus-visible:outline-1 peer-focus-visible:outline-offset-2 peer-focus-visible:outline-default peer-focus-visible:outline
        p-filled:bg-default dark:p-filled:bg-surface-800
