...
import type { AvatarPassThroughOptions, AvatarProps } from 'primevue/avatar';
...
const theme = ref<AvatarPassThroughOptions>({
  root: `inline-flex items-center justify-center
        w-8 h-8 text-complimentary-reg text-additional rounded-md
        bg-filling dark:bg-surface-700
