import { c as useForm, b as usePage, s as serverRenderer_cjs_prodExports, v as vueExports, h as head_default, l as link_default } from "../ssr.js";
    ...
    return (_ctx, _push, _parent, _attrs) => {
      _push(serverRenderer_cjs_prodExports.ssrRenderComponent(_sfc_main$1, _attrs, {
        default: vueExports.withCtx((_, _push2, _parent2, _scopeId) => {
          if (_push2) {
            _push2(serverRenderer_cjs_prodExports.ssrRenderComponent(vueExports.unref(head_default), { title: "Login By Phone Confirm" }, null, _parent2, _scopeId));
            ...
            _push2(serverRenderer_cjs_prodExports.ssrRenderComponent(_sfc_main$4, {
              class: "mt-2",
              message: vueExports.unref(form).errors.code
            }, null, _parent2, _scopeId));
            ...
            _push2(serverRenderer_cjs_prodExports.ssrRenderComponent(vueExports.unref(link_default), {
              ...
              default: vueExports.withCtx((_2, _push3, _parent3, _scopeId2) => {
                if (_push3) {
                  _push3(` Login By Email `);
                } else {
                  return [
                    vueExports.createTextVNode(" Login By Email ")
                  ];
                }
              }),
              _: 1
            ...
            return [
              vueExports.createVNode(vueExports.unref(head_default), { title: "Login By Phone Confirm" }),
...
_sfc_main.setup = (props, ctx) => {
  ...
  (ssrContext.modules || (ssrContext.modules = /* @__PURE__ */ new Set())).add("resources/js/src/pages/back/Auth/LoginByPhoneConfirm.vue");
