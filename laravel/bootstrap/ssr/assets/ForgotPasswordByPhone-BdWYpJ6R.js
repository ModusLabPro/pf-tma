import { b as usePage, c as useForm, s as serverRenderer_cjs_prodExports, v as vueExports, h as head_default } from "../ssr.js";
    ...
    return (_ctx, _push, _parent, _attrs) => {
      _push(serverRenderer_cjs_prodExports.ssrRenderComponent(_sfc_main$1, _attrs, {
        default: vueExports.withCtx((_, _push2, _parent2, _scopeId) => {
          if (_push2) {
            _push2(serverRenderer_cjs_prodExports.ssrRenderComponent(vueExports.unref(head_default), { title: "Forgot Password By Phone" }, null, _parent2, _scopeId));
            ...
            _push2(serverRenderer_cjs_prodExports.ssrRenderComponent(PrimaryButton, {
              ...
              default: vueExports.withCtx((_2, _push3, _parent3, _scopeId2) => {
                if (_push3) {
                  ...
                  return [
                    vueExports.createTextVNode(" Send Code ")
                  ];
                }
              }),
              _: 1
            ...
            return [
              vueExports.createVNode(vueExports.unref(head_default), { title: "Forgot Password By Phone" }),
...
_sfc_main.setup = (props, ctx) => {
  ...
  (ssrContext.modules || (ssrContext.modules = /* @__PURE__ */ new Set())).add("resources/js/src/pages/back/Auth/ForgotPasswordByPhone.vue");
