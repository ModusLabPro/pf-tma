...
return [
    ...
    'logo' => 'images/moonshine/img/logo/Logo.png',
    ...
    'pages' => [
        ...
        'cart_analytics' => App\MoonShine\Pages\UserCartAnalyticsPage::class,
        'reviews_export' => App\MoonShine\Pages\ReviewsExportPage::class,
        'loyalty_report' => App\MoonShine\Pages\LoyaltyReportPage::class,
